...
SELECT emp1.FirstName + ' ' + emp1.LastName AS Name, emp2.FirstName + ' ' + emp2.LastName AS Manager 
FROM Employees emp1
...
SELECT emp1.FirstName + ' ' + emp1.LastName AS Name, emp2.FirstName + ' ' + emp2.LastName AS Manager, a.AddressText AS Address 
FROM Employees emp1
JOIN Employees emp2 ON emp1.ManagerID = emp2.EmployeeID
...
AND (YEAR(emp.HireDate) > 1995 AND YEAR(emp.HireDate) < 2000)
