...
public class ExceptionsHomework
{
    public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
    {
        ...
        {
            throw new ArgumentOutOfRangeException("Count " + count + " is too big!");
        }
    ...
    public static void Main()
    {
        ...
        // The next line causes exception, because the count of symbols to return 
        // is bigger than the length of the string
